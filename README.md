...
1. **Distribution of Variables:**  
   ...
   **INSERT PLOT** Remember to specify the total number and proportions of each class.
...
### Conclusion  
Random Forest and Logistic Regression are equally strong models for this task, but their strengths differ. For higher recall on classes 0 and 2, we recommend Logistic Regression, while for higher precision, Random Forest is the better choice while both models performed comparably on class 1.
